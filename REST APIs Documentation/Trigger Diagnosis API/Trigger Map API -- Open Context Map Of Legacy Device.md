...
# Trigger Map API Design -- Context Map Of Legacy Device
...
|map_setting.context_map_legacy_device_para| object | parameters of legacy device context map |
|###|###| ***Note:*** if no value provided at here, legacy device will be set by basic_setting.device.|
| map_setting.context_map_legacy_device_para.device* | string | legacy device name. |
...
body = {
    ...
    "map_setting": {
        "map_create_mode": 5,
        "context_map_legacy_device_para": {
            "device": ""
        }
    }
}
